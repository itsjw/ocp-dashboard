...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_18__providers_printer_service__ = __webpack_require__("./src/app/providers/printer.service.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
    ...
    AppModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_5__angular_core__["NgModule"])({
            ...
            providers: [
                ...
                __WEBPACK_IMPORTED_MODULE_18__providers_printer_service__["a" /* PrinterService */]
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__environments_index__ = __webpack_require__("./src/environments/index.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_rxjs_Observable__ = __webpack_require__("./node_modules/rxjs/Observable.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_rxjs_Observable___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1_rxjs_Observable__);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__angular_core__ = __webpack_require__("./node_modules/@angular/core/esm5/core.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_nfc_pcsc__ = __webpack_require__("nfc-pcsc");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_nfc_pcsc___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_6_nfc_pcsc__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__nfcparser_service__ = __webpack_require__("./src/app/providers/nfc/nfcparser.service.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__ndefformater_service__ = __webpack_require__("./src/app/providers/nfc/ndefformater.service.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9_ndef_parser__ = __webpack_require__("./node_modules/ndef-parser/index.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9_ndef_parser___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_9_ndef_parser__);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var NfcService = (function () {
    function NfcService(NfcParser, ndefFormater) {
        ...
        // component vars
        this.DEBUG = __WEBPACK_IMPORTED_MODULE_0__environments_index__["a" /* environment */].debug;
        this.currentAction = 'READ_CARD_MESSAGE';
        this.nfcLib = new __WEBPACK_IMPORTED_MODULE_6_nfc_pcsc__["NFC"]();
        this.nfc = {
            reader: {
                name: null,
                status: {
        ...
        this.aCardHasBeenRead$ = new __WEBPACK_IMPORTED_MODULE_2_rxjs__["Subject"]();
        this.aCardHasBeenWritten$ = new __WEBPACK_IMPORTED_MODULE_2_rxjs__["Subject"]();
        this.aCardCouldntBeRead$ = new __WEBPACK_IMPORTED_MODULE_2_rxjs__["Subject"]();
        /**
         * Source Observable
         ...
         */
        this.onReader$ = __WEBPACK_IMPORTED_MODULE_2_rxjs__["Observable"].fromEvent(this.nfcLib, 'reader');
        /**
         * Events as Observables
         * We grab all the childs event of reader here and switchMap them to observables
         */
        this.onCard$ = this.onReader$.switchMap(function (readerEvent) { return __WEBPACK_IMPORTED_MODULE_1_rxjs_Observable__["Observable"].fromEvent(readerEvent, 'card'); });
        this.onCardOff$ = this.onReader$.switchMap(function (readerEvent) { return __WEBPACK_IMPORTED_MODULE_1_rxjs_Observable__["Observable"].fromEvent(readerEvent, 'card.off'); });
        this.onReaderEnd$ = this.onReader$.switchMap(function (readerEvent) { return __WEBPACK_IMPORTED_MODULE_1_rxjs_Observable__["Observable"].fromEvent(readerEvent, 'end'); });
        this.onReaderStatus$ = this.onReader$.switchMap(function (readerEvent) { return __WEBPACK_IMPORTED_MODULE_1_rxjs_Observable__["Observable"].fromEvent(readerEvent, 'status'); });
        this.onError$ = this.onReader$.switchMap(function (readerEvent) { return __WEBPACK_IMPORTED_MODULE_1_rxjs_Observable__["Observable"].fromEvent(readerEvent, 'error'); });
        /**
         * Reader and card subs.
         * Used in-class for inner data processing
         */
        // Reader - when we find a new reader
        this.onReader = this.onReader$.subscribe(function (reader) {
            // Declare the reader object for our class
            _this.reader = reader;
            _this.onCard$ = __WEBPACK_IMPORTED_MODULE_1_rxjs_Observable__["Observable"].fromEvent(_this.reader, 'card');
        });
        // card - when we find a card
        this.onCard = this.onCard$.subscribe(function (card) { return __awaiter(_this, void 0, void 0, function () {
            var _this = this;
            return __generator(this, function (_a) {
                if (this.DEBUG) {
                    console.info("(nfcS) - Processing card (uid:", card.uid + ')');
                }
                this.actionManager.onCard('READ_CARD_HEADER').then(function (rawHeader) {
                    console.log('(nfcS) -', 'rawHeader', rawHeader);
                    var headerValues = __WEBPACK_IMPORTED_MODULE_9_ndef_parser___default.a.parseHeader(rawHeader);
                    console.log(headerValues);
                    if (headerValues.hasTagReadPermissions && headerValues.isTagFormatedAsNdef && headerValues.hasTagANdefMessage) {
                        _this.actionManager.onCard('READ_CARD_MESSAGE', 4, headerValues.tagLengthToReadFromBlock4).then(function (ndefMessage) {
                            try {
                                console.log('adadada');
                                var parsedNdef = __WEBPACK_IMPORTED_MODULE_9_ndef_parser___default.a.parseNdef(ndefMessage);
                                // If sub-processing is needed it lands here.
                                // eg. parsing something special we need in the records
                                _this.aCardHasBeenRead$.next(parsedNdef);
                            }
                            catch (e) {
                                _this.aCardCouldntBeRead$.next(e);
                            }
                        });
                    }
                });
         ...
         */
        this.actionManager = {
            onCard: function (action, blockStart, length) {
                switch (action) {
                    case 'READ_CARD_MESSAGE':
                        return _this.readCard(4, length);
                    // break;
                    case 'READ_CARD_HEADER':
                        return _this.readCard(0, 20);
                    // break;
                    default:
                        break;
                }
     ...
     * @param {*} packetSize
     */
    NfcService.prototype.readCard = function (blockNumber, length, blockSize, packetSize) {
        if (blockSize === void 0) { blockSize = 4; }
        if (packetSize === void 0) { packetSize = 16; }
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.reader.read(blockNumber, length)];
                    case 1: 
                    ...
                    return [2 /*return*/, _a.sent()]; // await reader.write(4, data, 16); for Mifare Classic cards
                }
            });
        });
    };
     ...
     */
    NfcService.prototype.writeCard = function (blockNumber, data, blockSize) {
        if (blockSize === void 0) { blockSize = 4; }
        return __awaiter(this, void 0, void 0, function () {
            var writeData;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.reader.write(blockNumber, length)];
                    case 1:
                        writeData = _a.sent();
                        if (this.DEBUG) {
                            console.info("(nfcS) - data written", { reader: this.reader.name, writeData: writeData });
                        }
                        return [2 /*return*/];
                }
            });
    ...
    NfcService = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_7__nfcparser_service__["a" /* NfcParserService */], __WEBPACK_IMPORTED_MODULE_8__ndefformater_service__["a" /* NdefFormaterService */]])
    ], NfcService);
    return NfcService;
}());
...
var NfcParserService = (function () {
    ...
    NfcParserService.prototype.parseNdef = function (data) {
        var DEBUG = __WEBPACK_IMPORTED_MODULE_0__environments_index__["a" /* environment */].debug;
        if (DEBUG) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__("./node_modules/@angular/core/esm5/core.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_printer__ = __webpack_require__("printer");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_printer___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1_printer__);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var PrinterService = (function () {
    ...
    PrinterService.prototype.printText = function (textToPrint) {
        __WEBPACK_IMPORTED_MODULE_1_printer___default.a.printDirect({
            data: textToPrint,
